...
@interface NewFaxEdit1VC () {
    FaxTemplateView *faxTemplate;
}

@end

@implementation NewFaxEdit1VC

@synthesize backButton, nextButton;
@synthesize sendButton;

static NSString *tf1_default = @"PATIENT NAME";
...
- (void) renderFax
{
    ...
    faxTemplate.patient.text = self.tf1.text;
...
- (void) saveFaxLog:(NSString *)efaxID
{
    ...
    @try {
        if (account != nil) {
            ...
            faxlog.patient_name = self.tf1.text;
